...
const ContactUs = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      title: "Visit Us",
      info: "Koramangala, Bangalore, India",
    },
  ];
    ...
    <section id="contact" className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="section-title">
          <h2>Contact Us</h2>
          <p>
            Ready to transform your trading strategy into a powerful algorithm? Get in touch with our team.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
          <div className="lg:col-span-2">
            <LeadForm 
              ...
              subtitle="Tell us about your trading strategy and requirements. We'll get back to you within 24 hours." 
